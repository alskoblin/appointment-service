...
import (
	...
	"appointment-service/internal/billing/bootstrap"
...
func main() {
	...
	if err != nil {
		slog.Error("failed to load billing config", "error", err)
		os.Exit(1)
	}
	...
	if err := application.Run(ctx); err != nil {
		logger.Error("billing service stopped with error", "error", err)
		os.Exit(1)
	}
